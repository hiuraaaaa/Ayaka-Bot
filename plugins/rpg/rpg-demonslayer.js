let handler = async (m, { conn, text }) => {
  ...
  const reductions = {
    'King': { healt: 50, stamina: 40, strength: 20, defense: 20, attack: 30 },
    'Top': { healt: 30, stamina: 25, strength: 15, defense: 15, attack: 20 },
    'Mid': { healt: 20, stamina: 15, strength: 10, defense: 10, attack: 15 },
    'Low': { healt: 10, stamina: 10, strength: 5, defense: 5, attack: 10 },
    'Special': { healt: 15, stamina: 15, strength: 10, defense: 10, attack: 15 }
  };
  ...
  if (new Date - user.lasthunt > 300000) {
    ...
    user.healt -= healing + reduction.healt;
