...
_Uang yang anda miliki :_
*💸 Rp.${money}*

▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Kebutuhan   |   Harga Beli*_
💳 Limit:       ${Hblimit}
🎟️ TiketM:       ${Hbhealtmonster}
🎫 Cupon:       ${Hbtiketcoin}
🎫 KoinExpg:       ${Hbkoinexpg}

_*Kebutuhan   |   Harga Jual*_
💳 Limit:       ${Hslimit}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Bibit Buah   |   Harga Beli*_
🍌 BibitPisang:       ${Hbbibitpisang}
🍇 BibitAnggur:       ${Hbbibitanggur}
🥭 BibitMangga:       ${Hbbibitmangga}
🍊 BibitJeruk:       ${Hbbibitjeruk}
🍎 BibitApel:       ${Hbbibitapel}
📦 Gardenboxs:       ${Hbgardenboxs}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Barang   |   Harga Beli*_
🥤 Potion:       ${Hbpotion}
💎 Diamond:       ${Hbdiamond}
🪵 Coal:       ${Hbcoal}
🗑️ Sampah:       ${Hbsampah}
...
🧣Leather:       ${Hskulit}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Chest | Harga Beli*_
📦 Pet:       ${Hbpet}
📦 Uncommon:       ${Hbuncommon}
👑 Mythic:       ${Hbmythic}
💎 Legendary:       ${Hblegendary}
📦 Common:       ${Hbcommon}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Chest | Harga Jual*_
📦 Pet:       ${Hspet}
📦 Uncommon:       ${Hsuncommon}
👑 Mythic:       ${Hsmythic}
💎 Legendary:       ${Hslegendary}
📦 Common:       ${Hscommon}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Buah | Harga Beli*_
🍌 Pisang:       ${Hbpisang}
...
🍎 Apel:       ${Hsapel}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Minuman | Harga Beli*_
🥤 Aqua:       ${Hbaqua}

_*Minuman | Harga Jual*_
🥤 Aqua:       ${Hsaqua}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Fishing | Harga Beli*_
🎣 Pancingan:       ${Hbpancingan}
🍚 Umpan:       ${Hbumpan}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Equipment | Harga Beli*_
🧥 Armor:       ${Harmor}
⚔️ Sword:       ${Hbsword}
🦯 Sniper:       ${Hbsniper}
🖍️ Peluru:       ${Hbpeluru}
...
_*Equipment | Harga Jual*_
🖍️ Peluru:      ${Hspeluru}
🛢️ Aerozine:       ${Hsaero}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Peliharaan | Harga Beli*_
🐶 Pet:       ${Hbpet}
🐈 Kucing:       ${Hbkucing}
🐎 Kuda:       ${Hbkuda}
🐉 Naga:       ${Hbnaga}
...
🐺 Serigala:       ${Hbserigala}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Peliharaan | Harga Jual*_
> Beli hewan di !shoppet
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Makanan Pet | Harga Jual*_
📦 MakananPet:       ${Hbmakananpet}
🐉 MakananNaga:       ${Hbmakanannaga}
🦊 MakananKyubi:       ${Hbmakanankyubi}
🦅 MakananGriffin:       ${Hbmakanangriffin}
🕊️ MakananPhonix:       ${Hbmakananphonix}
🦖 MakananCentaur:       ${Hbmakanancentaur}
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
_*Makanan Pet | Harga Jual*_
📦 MakananPet:       ${Hsmakananpet}
🐉 MakananNaga       ${Hsmakanannaga}
🦊 Makanankyubi:       ${Hsmakanankyubi}
🦅 MakananGriffin:       ${Hsmakanangriffin}
🕊️ MakananPhonix:       ${Hsmakananphonix}
🦖 MakananCentaur:       ${Hsmakanancentaur}
`.trim()
    try {
