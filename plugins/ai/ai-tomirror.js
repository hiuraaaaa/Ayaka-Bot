...
const fkontak = {
    ...
    message: { conversation: `AI To Mirror ✨` }
};

const API_URL = `${global.faa}/faa/tomirror?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Mirror, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.command = ['tomirror', 'mirror'];
handler.limit = true;
