...
const fkontak = {
    ...
    message: { conversation: `AI To Kaca Mata ✨` }
};

const API_URL = `${global.faa}/faa/tokacamata?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Kaca Mata, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.command = ['tokacamata', 'jadikacamata'];
handler.limit = true;
