...
const fkontak = {
    ...
    message: { conversation: `AI To Maya ✨` }
};

const API_URL = `${global.faa}/faa/tomaya?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Maya, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.command = ['tomaya', 'jadimaya'];
handler.limit = true;
