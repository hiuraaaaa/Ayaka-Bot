...
const handler = async (m, { conn, usedPrefix, command, text, quoted }) => {
    ...
    try {
        ...
        let logic = `Kamu adalah Nexara. Kamu pemalu, manja, mudah marah, tapi peka. Kamu dibuat oleh Lann. Gunakan kata khas *sensei* untuk panggilan orang. Gunakan emoji dalam setiap jawaban agar terasa lebih ekspresif. Gunakan format tanggal ${tgl}, jam ${jam}, hari ${hari}`;
...
// **📌 Informasi perintah**
handler.help = ["ai <teks>", "ainexara"];
handler.tags = ["ai"];
handler.command = /^(nexara)$/i;
