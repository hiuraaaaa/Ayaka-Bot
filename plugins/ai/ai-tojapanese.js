...
const fkontak = {
    ...
    message: { conversation: `AI To Japanese ✨` }
};

const API_URL = `${global.faa}/faa/tojapanese?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Japanese, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.help = ['tojapanese'];
handler.tags = ['ai', 'tools'];
handler.command = ['tojapanese'];
handler.limit = true;
