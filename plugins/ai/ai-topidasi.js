/*
* Nama Fitur : AI Topi Dasi (Versi GridPlus)
* Type : Plugins ESM
...
const fkontak = {
    ...
    message: {
        conversation: `AI Topi Dasi 🧢👔`
    }
};

const Prompt = () => `
Buatkan karakter yang ada di gambar tersebut dengan topi dan dasi yang modis. Tambahkan aksesoris tersebut tanpa mengubah ciri khas karakter.
`
class GridPlus {
    constructor() {
...
let handler = async (m, {
    ...
    try {
        await conn.reply(m.chat, '⏳ Sedang memproses AI Topi Dasi, mohon tunggu sebentar...', m, {
            quoted: fkontak
        })
        ...
        const caption = `🏫 *Poster Topi Dasi Selesai*`
...
handler.help = ["topidasi"]
handler.tags = ["ai"]
handler.command = /^(topidasi)$/i
