...
const fkontak = {
    ...
    message: { conversation: `AI To Chibi ✨` }
};

const API_URL = `${global.faa}/faa/tochibi?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Chibi, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.command = ['tochibi', 'jadichibi', 'chibi'];
handler.limit = true;
