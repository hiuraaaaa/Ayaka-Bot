...
const fkontak = {
    ...
    message: { conversation: `AI To Brewok ✨` }
};

const API_URL = `${global.faa}/faa/tobrewok?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Brewok, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.help = ['tobrewok'];
handler.tags = ['ai', 'tools'];
handler.command = ['tobrewok', 'jadibrewok', 'brewokkan', 'tobawok', 'jadibawok', 'bawokkan'];
handler.limit = true;
