...
const fkontak = {
    ...
    message: { conversation: `AI To Kamboja ✨` }
};

const API_URL = `${global.faa}/faa/tokamboja?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Kamboja, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.help = ['tokamboja'];
handler.tags = ['ai', 'tools'];
handler.command = ['tokamboja', 'jadikamboja'];
handler.limit = true;
