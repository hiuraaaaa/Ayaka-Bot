...
const fkontak = {
    ...
    message: { conversation: `AI To Roblox 🤖` }
};

const API_URL = `${global.faa}/faa/toroblox?url=`;
...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '⏳ Sedang memproses AI To Roblox, mohon tunggu sebentar...' }, { quoted: fkontak });
...
handler.help = ['toroblox'];
handler.tags = ['ai', 'tools'];
handler.command = ['toroblox', 'jadiroblox'];
handler.limit = true;
