let handler = async (m, { conn, command, text, args }) => {
    if (!text) throw 'Format salah!\n\nTambah money: addhealt <tag orang> <jumlah healt>\nKurangi healt: removehealt <tag orang> <jumlah healt>'
    ...
    healtValue = parseInt(moneyValue)
...
handler.help = ['addhealt', 'remhealt']
handler.tags = ['owner']
handler.command = /^(add|rem)healt$/i
handler.rowner = true
